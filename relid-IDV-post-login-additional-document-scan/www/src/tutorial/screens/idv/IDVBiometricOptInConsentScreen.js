  ...
  async handleClose() {
    ...
    try {
      if (this.state.challengeMode === 8) {
        ...
        console.log('IDVBiometricOptInConsent - Pre-login flow detected, calling resetAuthState to cancel IDV flow');
        ...
        console.log('IDVBiometricOptInConsent - Post-login flow detected, navigating to ActivatedCustomerKYC screen');
        ...
        console.log('IDVBiometricOptInConsent - Navigated to ActivatedCustomerKYC, button will be auto-enabled');
      }
    } catch (error) {
      console.error('IDVBiometricOptInConsent - Close button error:', JSON.stringify(error, null, 2));
