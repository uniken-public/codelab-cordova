...
This folder contains the source code for the solution of the [REL-ID Initialize](https://codelab.uniken.com/codelabs/cordova-relid-initialization-flow/index.html?index=..%2F..index#0)
