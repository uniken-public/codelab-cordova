...
class RdnaEventManager {
  ...
  registerEventListeners() {
    ...
    console.log('RdnaEventManager - Native event listeners registered (including MTD, MFA, Session, Device Activation, Notifications, Password Update, and LDA Toggling)');
  }
