 ...
 * 2.5. SDKIDVEventProvider.initialize() - Registers IDV navigation handlers (if available)
...
const AppInitializer = {
  ...
  initialize() {
    ...
    try {
      ...
      // Step 2.5: Initialize SDK IDV event provider (registers IDV navigation handlers)
      if (typeof SDKIDVEventProvider !== 'undefined') {
        console.log('AppInitializer - Initializing SDKIDVEventProvider');
