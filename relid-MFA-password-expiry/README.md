...
This folder contains the source code for the solution demonstrating [REL-ID Password Expiry Management](https://codelab.uniken.com/codelabs/cordova-password-expiry-flow/index.html?index=..%2F..index#0) using secure expired password update flows with password reuse detection in a Cordova Single Page Application.
